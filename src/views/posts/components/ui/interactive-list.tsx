...
export const InteractiveList = ({ className }: ComponentProps<'div'>) => {
    ...
    <div className='flex gap-7'>
      <div className=" flex items-center gap-2 text-lg text-gray-500 transition duration-350 ease-in-out">
        <Dialog>
          ...
          <DialogContent>
            <DialogHeader >
              <DialogTitle className='m-auto'>{t('sure.like')}</DialogTitle>
              <DialogDescription className='flex items-center flex-col '>
                ...
                <div className={cn(' w-[400px]' , i18n.language === 'zh' ?'text-center' :'text-start')}>

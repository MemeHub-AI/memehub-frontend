                ...
                <div className={cn('flex flex-col py-1')}>
                    <div className="flex items-center">
                        ...
                        <div className="ml-3 flex justify-between w-full lg:w-[500px] items-center">
                            ...
                            {p.isLaunched ?
                                (p.isDetailed && <span className='bg-purple-500 rounded-md p-1 text-white  font-bold'>
                                    {t('started')}
                                </span>) : 
                    ...
                    <div className="pl-14 mt-2">
                        ...
                        <Progress value={60} className='mb-3 text-black h-4 lg:w-[500px] rounded-sm border border-black border-solid ' indicatorClass="bg-red-500">

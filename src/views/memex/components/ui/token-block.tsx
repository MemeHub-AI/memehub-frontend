    ...
    <div className=" border border-solid border-gray-400 rounded-md mt-2 lg:w-[500px]">
      <div className="relative">
        ...
        <div className="ml-14 pt-1">
          <div>
            <span className="text-gray-500">{t('codeName')} : </span> HEYI
          </div>
          <div>
            <span className="text-gray-500">{t('fullName')} : </span> Binance
            HeYi
          </div>
        </div>
      </div>
      <div className="flex px-2 my-2 max-lg:justify-between items-center">
        ...
        {type === 1 && (
          <Button className="border border-solid border-gray-500 p-1 rounded-md lg:ml-9 sm:mr-2 mr-1">
            {t('go.trade')}
          </Button>
        )}
      </div>
